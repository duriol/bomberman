...
export const CHARACTER_DEFS = {
  foxy: {
    ...
    abilityDesc: 'Foxy puede activar o desactivar su habilidad de atravesar bombas. Solo puede patear bombas cuando la habilidad está desactivada.',
  ...
  dracarys: {
    ...
    abilityDesc: 'Se carga 1s con efecto de color/parpadeo sin moverse y luego lanza fuego recto con alcance maximo en la direccion que mira.',
    hasActiveAbility: true,
